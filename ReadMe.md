...
Form validation first must check that all the mandatory fields are filled with a given value, and then the fields must also require the right format/data value (An "@" and ".<something>" for emails for example)

3. In 1-2 sentences, define end to end testing. 

End-to-end tests allows debugging by simulating the users actions by using scripts
